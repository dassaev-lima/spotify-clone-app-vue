<template>
    <div class="flex flex-row grow items-center justify-start space-x-8 h-20 shrink-0 sm:w-full md:w-5/6 lg:w-1/4 rounded-md bg-gradient-to-b from-neutral-500 to-neutral-700">
